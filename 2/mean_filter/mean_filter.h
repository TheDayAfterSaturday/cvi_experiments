...
#define  MYPANEL                          1
#define  MYPANEL_MEAN_FILTER              2       /* control type: command, callback function: Mean_Filter */
...
int  CVICALLBACK Mean_Filter(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
